...
// Cluster URI
const DATABASE_URL = process.env.DATABASE_URI||'mongodb+srv://iamshalu0511:Shalu2001@cluster0.rgmakrb.mongodb.net/subscribers?retryWrites=true&w=majority';

console.log("DATABASE_URI:", process.env.DATABASE_URI); // Add this line
